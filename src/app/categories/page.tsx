    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20 lg:pb-0">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="gap-2 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-violet-900/20"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {loading
          ...
          : categories.map((cat) => (
              <GlassCard
                key={cat.id}
                className="p-4 flex items-center justify-between group hover:border-border/80 transition-colors"
              >
                <div className="flex items-center gap-4">
                  <div
                    className={cn(
                      'h-12 w-12 flex items-center justify-center rounded-xl shadow-lg text-white',
                      cat.color,
                    )}
                  >
