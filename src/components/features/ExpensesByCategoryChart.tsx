      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 mb-4 shrink-0">
        ...
        <div className="flex bg-muted p-1 rounded-lg self-stretch sm:self-auto">
          <button
            ...
            className={cn(
              'flex-1 sm:flex-none px-3 py-1 text-[10px] font-medium rounded transition-all',
          ...
          <button
            ...
            className={cn(
              'flex-1 sm:flex-none px-3 py-1 text-[10px] font-medium rounded transition-all',
              filter === 'individual' ? 'bg-blue-500 text-white shadow' : 'text-muted-foreground hover:text-foreground',
            )}
          >
            Individual
          </button>
          <button
            ...
            className={cn(
              'flex-1 sm:flex-none px-3 py-1 text-[10px] font-medium rounded transition-all',
              filter === 'shared' ? 'bg-purple-500 text-white shadow' : 'text-muted-foreground hover:text-foreground',
            )}
          >
            Grupal
          </button>
