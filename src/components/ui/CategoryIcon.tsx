import { 
  Utensils, Home, Lightbulb, Clapperboard, Car, ShoppingBag, 
  Plane, FileText, Dumbbell, Stethoscope, GraduationCap, Gamepad2, 
  Wine, Gift, Baby, Dog, HelpCircle, Smartphone, Wifi, 
  CreditCard, Banknote, Briefcase, Wrench, Hammer, Zap, 
  Coffee, Music, Book, Camera, 
  LucideIcon
} from "lucide-react";
...
export function CategoryIcon({ iconName, className }: CategoryIconProps) {
  ...
  return <span className={cn("shrink-0 text-current leading-none", className)} style={{ fontSize: '1.2em' }}>{iconName}</span>;
}
